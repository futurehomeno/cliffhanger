...
func setupPresence(
	...
	presenceThing := newPresenceThing(ad, cfg)

	ad.RegisterThing(presenceThing)

	return routePresenceThing(ad), taskPresenceThing(ad, duration), mocks
}

// presenceThingConfig represents a config for testing presence service.
...
func newPresenceThing(
	...
	services := []adapter.Service{
		presence.NewService(a, cfg.PresenceConfig),
	}
