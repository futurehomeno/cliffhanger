...
type Default struct {
	...
	TelemetryEnabledAt       time.Time     `json:"telemetry_enabled_at,omitempty"`
	TelemetryValidity        time.Duration `json:"telemetry_validity,omitempty"`
	TelemetryDisabledDomains []string      `json:"telemetry_disabled_domains,omitempty"`
