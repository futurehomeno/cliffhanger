...
func NewClient(syncClient *fimpgo.SyncClient, resourceName string) Client {
...
func NewCloudClient(syncClient *fimpgo.SyncClient, cloudServiceName string, siteUUID string) Client {
	responseAddress := fimpgo.Address{
...
func (c *client) sendGetRequest(components []string) (*Response, error) {
	...
	message := fimpgo.NewMessage(CmdPD7Request, "vinculum", fimpgo.VTypeObject, request, nil, nil, nil)
