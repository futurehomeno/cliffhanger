...
func TestClient(t *testing.T) {
	...
	tt := []struct {
		...
		call           func(client prime.Client) (any, error)
		want           any
		wantErr        bool
	}{
		{
			...
			call:    func(client prime.Client) (any, error) { return client.GetDevices() },
		...
		},
		{
			...
			call:    func(client prime.Client) (any, error) { return client.GetThings() },
		...
		},
		{
			...
			call:    func(client prime.Client) (any, error) { return client.GetRooms() },
		...
		},
		{
			...
			call:    func(client prime.Client) (any, error) { return client.GetAreas() },
		...
		},
		{
			...
			call:    func(client prime.Client) (any, error) { return client.GetHouse() },
		...
		},
		{
			...
			call:    func(client prime.Client) (any, error) { return client.GetHub() },
		...
		},
		{
			...
			call:    func(client prime.Client) (any, error) { return client.GetShortcuts() },
		...
		},
		{
			...
			call:    func(client prime.Client) (any, error) { return client.GetModes() },
		...
		},
		{
			...
			call:    func(client prime.Client) (any, error) { return client.GetTimers() },
		...
		},
		{
			...
			call:    func(client prime.Client) (any, error) { return client.GetVinculumServices() },
		...
		},
		{
			...
			call:    func(client prime.Client) (any, error) { return client.GetState() },
			want:    &prime.State{},
			wantErr: false,
		},
		{
		...
		},
		{
			...
			call:    func(client prime.Client) (any, error) { return client.GetAll() },
		...
		},
		{
			...
			call:           func(client prime.Client) (any, error) { return client.GetComponents("unknown") },
			want:           (*prime.ComponentSet)(nil),
			wantErr:        true,
		},
		{
			...
			call:    func(client prime.Client) (any, error) { return client.RunShortcut(1) },
		...
		},
		{
			...
			call:    func(client prime.Client) (any, error) { return client.ChangeMode("away") },
			want:    &prime.Response{Success: true},
			wantErr: false,
		},
		{
		...
		},
		{
			...
			syncClientMock: mockSyncClientResponse(t, json.RawMessage(`{"cmd":true}`), nil),
			call:           func(client prime.Client) (any, error) { return client.ChangeMode("home") },
			want:           (*prime.Response)(nil),
			wantErr:        true,
		},
	}
...
func mockSyncClientResponse(t *testing.T, response any, err error) *mockedprime.SyncClient {
	t.Helper()
