...
func TestNotify(t *testing.T) {
	...
	tt := []struct {
		name    string
		notify  *prime.Notify
		call    func(n *prime.Notify) (interface{}, error)
		want    interface{}
		wantErr bool
	}{
		{
			...
			call:    func(n *prime.Notify) (interface{}, error) { return n.ParseIntegerID() },
			want:    1,
			wantErr: false,
		},
		{
		...
		},
		{
			...
			call:    func(n *prime.Notify) (interface{}, error) { return n.GetDevice() },
		...
		},
		{
			...
			call:    func(n *prime.Notify) (interface{}, error) { return n.GetThing() },
		...
		},
		{
			...
			call:    func(n *prime.Notify) (interface{}, error) { return n.GetRoom() },
		...
		},
		{
			...
			call:    func(n *prime.Notify) (interface{}, error) { return n.GetArea() },
...

		{
			...
			call:    func(n *prime.Notify) (interface{}, error) { return n.GetHouse() },
			want:    &prime.House{},
			wantErr: false,
		},
		{
		...
		},
		{
			...
			call:    func(n *prime.Notify) (interface{}, error) { return n.GetHub() },
			want:    &prime.Hub{},
			wantErr: false,
		},
		{
...

		{
			...
			call:    func(n *prime.Notify) (interface{}, error) { return n.GetShortcut() },
		...
		},
		{
			...
			call:    func(n *prime.Notify) (interface{}, error) { return n.GetMode() },
		...
		},
		{
			...
			call:    func(n *prime.Notify) (interface{}, error) { return n.GetTimer() },
		...
		},
		{
			...
			call:    func(n *prime.Notify) (interface{}, error) { return n.GetService() },
