...
func (_m *Adapter) CreateThing(id string, info interface{}) error {
...
func (_m *Adapter) DestroyThing(id string) error {
	ret := _m.Called(id)
...
func (_m *Adapter) EnsureThings(idsAndInfo map[string]interface{}) error {
...
func (_m *Adapter) SendAllNodesReport() error {
	ret := _m.Called()
...
func (_m *Adapter) SendExclusionReport(address string) error {
	ret := _m.Called(address)
...
func (_m *Adapter) publishAdapterMessage(message *fimpgo.FimpMessage) error {
...
func (_m *Adapter) publishServiceMessage(service adapter.Service, message *fimpgo.FimpMessage) error {
...
func (_m *Adapter) publishThingMessage(thing adapter.Thing, message *fimpgo.FimpMessage) error {
