...
type mockConstructorTestingTNewControllableConnector interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewControllableConnector(t mockConstructorTestingTNewControllableConnector) *ControllableConnector {
