...
// NewExtendedAdapter creates a new instance of ExtendedAdapter. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewExtendedAdapter(t testing.TB) *ExtendedAdapter {
