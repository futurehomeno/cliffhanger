...
type mockConstructorTestingTNewAdjustableCurrentController interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewAdjustableCurrentController(t mockConstructorTestingTNewAdjustableCurrentController) *AdjustableCurrentController {
