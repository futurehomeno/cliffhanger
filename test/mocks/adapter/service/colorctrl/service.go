...
// StartTransition provides a mock function with given fields: transitionObject
func (_m *Service) StartTransition(transitionObject map[string]interface{}) error {
...
// StopTransition provides a mock function with given fields: value
func (_m *Service) StopTransition(value string) error {
	ret := _m.Called(value)
