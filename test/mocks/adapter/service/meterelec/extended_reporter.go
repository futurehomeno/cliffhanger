...
// NewExtendedReporter creates a new instance of ExtendedReporter. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewExtendedReporter(t testing.TB) *ExtendedReporter {
