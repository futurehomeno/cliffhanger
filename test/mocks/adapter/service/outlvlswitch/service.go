...
// SetLevel provides a mock function with given fields: value
func (_m *Service) SetLevel(value int64) error {
	ret := _m.Called(value)
...
// SetLevelWithDuration provides a mock function with given fields: value, duration
func (_m *Service) SetLevelWithDuration(value int64, duration int64) error {
