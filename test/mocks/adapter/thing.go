...
// NewThing creates a new instance of Thing. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewThing(t testing.TB) *Thing {
	mock := &Thing{}
	mock.Mock.Test(t)
