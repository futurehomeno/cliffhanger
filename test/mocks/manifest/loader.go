...
// NewLoader creates a new instance of Loader. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewLoader(t testing.TB) *Loader {
	mock := &Loader{}
	mock.Mock.Test(t)
